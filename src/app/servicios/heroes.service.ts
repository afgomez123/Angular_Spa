...
export class HeroesService {
  ...
  // llenaoms un arreglo con los valores encontrados en el buscado
  // buscarHeroes(termino: string) {
  //   console.log("servicio:______________****S******____________" + termino);
  //   // variable de tipo interfaz
  //   let heroesArr: Heroe[] = [];
  //   termino = termino.toLowerCase();
  //   console.log("minuscula:_____________________" + termino);

  //   for (let heroe of this.heroes) {
  //     let nombre = heroe.nombre.toLowerCase();

  //     if (nombre.indexOf(termino) >= 0) {
  //       console.log("indexof:________________" + nombre.indexOf(termino));
  //       console.log("nombre:______" + nombre);
  ...
  //   return heroesArr;
  // }
  // Funcion mejorada que agrega idx como id unico en el arreglo
  buscarHeroes(termino: string) {
    console.log("servicio:______________****S******____________" + termino);
    // variable de tipo interfaz
    let heroesArr: Heroe[] = [];
